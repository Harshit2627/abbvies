  ...
  return (
    <div>
      <Row>
        ...
        <Link href={AppRoutes.PRODUCTS}><b>Products</b></Link>
          <p>&#8226; Bone Health</p>
        ...
        <Col xxl={8} xl={8} lg={8} md={12} className="footerCols">
        <Link href={AppRoutes.ABOUT_US}><b>About Us</b></Link>
          <p>&#8226; Team</p>
          <p>&#8226; Board</p>
          <p>&#8226; Manufacturing</p>
        </Col>
        <Col xxl={8} xl={8} lg={8} md={12} className="footerCols">
          <Link href={AppRoutes.CONTACT}><b>Contact</b></Link>
          <p>&#8226; Email : example@abbvies.com</p>
          <p>&#8226; Phone : +91 XXXXXXXX</p>
          <p>&#8226; Follow : {"   "}<FacebookFilled color="#E2E2E2" style={{marginRight: "12px"}}/>{"   "}<InstagramFilled color="#E2E2E2" style={{marginRight: "12px"}}/>{"   "}<TwitterCircleFilled color="#E2E2E2"/>
